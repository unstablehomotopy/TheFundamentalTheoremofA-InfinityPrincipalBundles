...
\newunicodechar{∇}{\scalebox{0.69}[1.1]{\raisebox{0.0cm}{$\scriptscriptstyle \nabla$}}}
...
\AddToShipoutPicture*
  {\put(470,752){
    \href{https://github.com/linlib/CategoriesandHilbertSpaces/CategoriesandHilbertSpaces.tex}{\texttt{.tex file}}\\
...
\AddToShipoutPicture*
  {\put(470,737){
    ...
    \href{http://linearlibrary.net/CategoriesandHilbertSpaces/CategoriesandHilbertSpaces.pdf}{\texttt{.pdf file}}\\

  }}

  \AddToShipoutPicture*
  {\put(470,722){
    \href{https://github.com/linlib/CategoriesandHilbertSpaces/CategoriesandHilbertSpaces.lean}{\texttt{.lean file}}
...
%LEAN: 
\begin{center}
\begin{tcolorbox}[width=6.3in,colback={white},coltitle=white]
\begin{center}
\scalebox{1.8}{\texttt{The Recognition Theorem,}}\\
\ \\
\scalebox{1.8}{\texttt{The Fundamental Theorem of Principal Bundles,}}\\
\ \\
\scalebox{1.8}{\texttt{and Two Variations Each}}
\end{center}
\end{tcolorbox}
\end{center}
\ \\
...
%LEAN: 
\begin{center}
\begin{tcolorbox}[width=1.8in,colback={white},coltitle=white]
\scalebox{1.6}{E. Dean Young}
\end{tcolorbox}
\end{center}
...
\section{Operadic Groups and Operadic Group Actions}
...
\begin{enumerate}
\item \href{https://math.ucr.edu/home/baez/calgary/BG.html}{A blog post of John Baez on Generalized Cohomology Theories and Eilenberg-Mac Lane Spaces}
\end{enumerate}
