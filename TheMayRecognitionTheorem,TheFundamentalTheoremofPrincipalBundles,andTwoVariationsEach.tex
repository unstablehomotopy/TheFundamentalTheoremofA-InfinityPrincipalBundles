...
\newunicodechar{∂}{$\partial$}%\raisebox{-1cm}{\partial}
...
\begin{center}
\scalebox{1.8}{\texttt{Two Theorems in Classifying Space Theory}}\\
\ \\
\scalebox{1.8}{\texttt{and}}\\
\ \\
\scalebox{1.8}{\texttt{Two Variations Each}}
\end{center}
\end{tcolorbox}
\end{center}
\ \\
